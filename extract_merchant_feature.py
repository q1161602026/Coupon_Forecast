...
# 	t3 = merchant_coupon_notused_count(feature)
	...
	# 商家被核销优惠券中的(平均、最小、最大、最多)商家距离
	t4,t5,t6,t7 = merchant_distances(feature)
	
	# 商家优惠券被核销天数
	t9,t10,t11,t12 = merchant_datereceived_days(feature)
...
# 	merchant = pd.merge(merchant,t3,on='Merchant_id',how='left')
	...
	merchant = pd.merge(merchant,t12,on='Merchant_id',how='left')
